...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        txtListChild1.setText(Html.fromHtml("<u>" + childText.substring(0, i) + "</u>"));
     /*   txtListChild1.setText(childText.substring(0, i)); */
  
        TextView txtListChild2 = (TextView) convertView
                .findViewById(R.id.lblListItem2);
        txtListChild2.setText(childText.substring(i+1, childText.length()));
